...
One of the most used 3rd party libraries is `class-variance-authority` which allows us to easily create component variants. I reccomend installing it into your project if you're using Unstyled Components:
